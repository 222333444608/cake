...
public class ShangjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShangjiaEntity user = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangjiamingcheng", username));
    ...
    public R register(@RequestBody ShangjiaEntity shangjia){
    	...
    	ShangjiaEntity user = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangjiamingcheng", shangjia.getShangjiamingcheng()));
		if(user!=null) {
